...
fun RecipeApp() {
    Surface(color = Color.Yellow) {
        Column {
            TopAppBar(
                title = { Text("Легка вечеря – 8 рецептів") },
            )
            LazyColumn {
...
val recipeList = listOf(
    Recipe("Печеня з тофу", "тофу – від 630 до 650 г;\n" +
            ...
            "кешью – ½ склянки;\n" +
            "крохмаль з кукурудзи – не більше столової ложки.", R.drawable.legka_vecherja_10_receptiv_shvidkih_i_smachnih_deea9c0),
    ...
    Recipe("Куряче філе, тушковане з ананасами і стручкової квасолею", "курячих грудок – кіло вагою приблизно 200 г;\n" +
            ...
            "улюблених спецій і солі.", R.drawable.legka_vecherja_10_receptiv_shvidkih_i_smachnih_1b19a1e),
    ...
    Recipe("Легка куряча грудка по-дижонски\n", "курячого філе – візьмемо 2 кг;\n" +
            ...
            "прованських трав (раз вже вибрали французьке блюдо, будемо послідовними до кінця) – 2-х чайних ложок.", R.drawable.legka_vecherja_10_receptiv_shvidkih_i_smachnih_f4d29e1),
    ...
    Recipe("Стейк з яловичини з грибами\n", "яловичина – досить 700 г;\n" +
            ...
            "крохмаль з кукурудзи – пари чайних ложок цілком достатньо.", R.drawable.legka_vecherja_10_receptiv_shvidkih_i_smachnih_87a61cc),
    ...
    Recipe("Легкий стейк з лосося у фользі\n", "ососеві стейки – візьмемо 4 штуки;\n" +
            ...
            "часник – двох зубков буде достатньо.", R.drawable.legka_vecherja_10_receptiv_shvidkih_i_smachnih_1bcb8b7),
    ...
    Recipe("Лазанья з сосисками – просто і швидко", "фарш з м’яса курки або індички – візьмемо 300 г;\n" +
            ...
            "рослинна олія – 3 столових ложок цілком достатньо.", R.drawable.legka_vecherja_10_receptiv_shvidkih_i_smachnih_bac690d),
    ...
    Recipe("Спагетті з соусом з базиліка на вечерю", "спагетті – візьмемо 200 г;\n" +
            ...
            "часник – не більше 2-х зубков.", R.drawable.legka_vecherja_10_receptiv_shvidkih_i_smachnih_d8342ae),
    ...
    Recipe("Сирна запіканка з макаронами на вечерю", "макарони і сир – відповідно 300 і 400 г;\n" +
            ...
            "сіль і приправи додайте на свій смак.", R.drawable.legka_vecherja_10_receptiv_shvidkih_i_smachnih_2f2a9b3)
)
